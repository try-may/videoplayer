...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_MyVideoWidget_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_MyVideoWidget_t qt_meta_stringdata_MyVideoWidget = {
    {
QT_MOC_LITERAL(0, 13) // "MyVideoWidget"
...
const QMetaObject MyVideoWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_MyVideoWidget.offsetsAndSize,
    qt_meta_data_MyVideoWidget,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_MyVideoWidget_t
, QtPrivate::TypeAndForceComplete<MyVideoWidget, std::true_type>
